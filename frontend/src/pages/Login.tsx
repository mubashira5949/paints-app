          ...
          <div className="space-y-2 group">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 bg-white/50 py-2.5 pl-10 pr-4 text-black placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20 transition-all disabled:opacity-50"
          ...
          <div className="space-y-2 group">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isLoading}
                placeholder="••••••••"
                className="w-full rounded-xl border border-slate-300 bg-white/50 py-2.5 pl-10 pr-10 text-black placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20 transition-all disabled:opacity-50"
                value={password}
                onChange={(e) => {
